...
<body>
	...
	<form class="">
		...
		<div class="">
			...
			<select class="form-control select2-multi searchOption" id="multi-select2" >
				<optgroup label="검색분류">
...
$(function(){
			 ...
			 $(document).on('click', '#up', function(){
			    ...
			    $.ajax({
			    	...
			    	success : function(res){
				        ...
				        $.ajax({
							 url : '/DTkkiri/subBlacklistView.do',
							 type : 'post',
							 data : {"roomNum" : <%= room %>},
							 success : function(res){
										code = '<table class="table border table-hover bg-white">';
										code +='	<thead class="theadClass">';
										code +='		<tr role="row"  class="thClass">';
										code +='				<!-- title head -->';
										code +='				<th>이메일</th>';
										code +='				<th>날짜</th>';
										code +='				<th>사유</th>';
			 ...
			 $('#Search').on('click', function(){
				...
				$.ajax({
					 url : '/DTkkiri/subAdminSearch.do',
					 data : {"keyword" : keyword, "word" : word, "roomNum" : <%= room %>},
					 type : 'post',
					 success : function(res){
								code = '<table class="table border table-hover bg-white">';
								code +='	<thead class="theadClass">';
