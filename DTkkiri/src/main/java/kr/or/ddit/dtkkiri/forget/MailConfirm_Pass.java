...
//메일 API
@WebServlet("/mailConfirm_Pass.do")
public class MailConfirm_Pass extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		props.put("mail.smtp.starttls.enable", "true");
	      ...
	      try {
	         ...
	         // Subject
	         // 메일 제목
	         message.setSubject("[DT끼리] 비밀번호찾기 인증메일입니다.");
	         
	         
	         // Text
	         // 메일 내용
	         message.setText("send!!");      // 텍스트 보내기
	         message.setContent("안녕하세요. 'DT끼리' 커뮤니티 비밀번호찾기 인증메일입니다. <br>"
