...
@WebServlet("/plusWarning.do")
public class PlusWarning extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(war == 3) {
			...
			bvo.setBkl_mail(email);
			bvo.setBkl_rsn("경고횟수 3회로 인한 블랙리스트 추가");
			
			blkService.insertBlacklist(bvo);
		}
