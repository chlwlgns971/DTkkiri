...
@WebServlet("/AdminSerch.do")
public class AdminSerch extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, 
		...
		if((keyword != null && word != null) && (!"".equals(keyword) && !"".equals(word))){
			...
			memberList = mService.searchAdminById(map);
			
			System.out.println("memberList 나오니? >>" +memberList);
			...
			memberList = mService.searchAllMember();
